...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return AssistantProto.internal_static_google_assistant_embedded_v1alpha2_AudioInConfig_descriptor;
  }

  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return AssistantProto.internal_static_google_assistant_embedded_v1alpha2_AudioInConfig_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            AudioInConfig.class, Builder.class);
  }
  ...
  public enum Encoding
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return AudioInConfig.getDescriptor().getEnumTypes().get(0);
    }
  ...
  public Encoding getEncoding() {
    Encoding result = Encoding.valueOf(encoding_);
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (encoding_ != Encoding.ENCODING_UNSPECIFIED.getNumber()) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof AudioInConfig)) {
      return super.equals(obj);
    }
    AudioInConfig other = (AudioInConfig) obj;
  ...
  public static AudioInConfig parseFrom(
  ...
  public static AudioInConfig parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static AudioInConfig parseFrom(
  ...
  public static AudioInConfig parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static AudioInConfig parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static AudioInConfig parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(AudioInConfig prototype) {
  ...
  public static final class Builder extends
    ...
    public AudioInConfig getDefaultInstanceForType() {
      return AudioInConfig.getDefaultInstance();
    }

    public AudioInConfig build() {
      AudioInConfig result = buildPartial();
    ...
    public AudioInConfig buildPartial() {
      AudioInConfig result = new AudioInConfig(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof AudioInConfig) {
        return mergeFrom((AudioInConfig)other);
      } else {
    ...
    public Builder mergeFrom(AudioInConfig other) {
      if (other == AudioInConfig.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      AudioInConfig parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (AudioInConfig) e.getUnfinishedMessage();
  ...
  private static final AudioInConfig DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AudioInConfig();
  }

  public static AudioInConfig getDefaultInstance() {
